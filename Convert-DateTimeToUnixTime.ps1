<#
.SYNOPSIS
  The "Convert-DateTimeToUnixTime" function takes a given date/time string and it will convert it to the Epoch / Unix timestamp format
.DESCRIPTION
.EXAMPLE
  ...
  1623682739
  PS C:\>
  PS C:\> Convert-DateTimeToUnixTime '2021-06-14T14:58:59Z'
  1623682739
