<#
.SYNOPSIS
  The "Convert-DateTimeToRFC3339" take a give date/time string and converts it an RFC3399 compatible date/time string.
...
.NOTES
  ...
  .
#>
function Convert-DateTimeToRFC3339 {
  [CmdletBinding()]
