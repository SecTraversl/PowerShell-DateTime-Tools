<#
.SYNOPSIS
  The "Convert-DateTimeFromUnixTime" function takes a given Epoch / Unix timestamp and returns the value of the human readable format.
.DESCRIPTION
.EXAMPLE
  PS C:\> <example usage>
...
.OUTPUTS
.NOTES
  Name:  Convert-DateTimeFromUnixTime.ps1
  Author:  Travis Logue
...
function Convert-DateTimeFromUnixTime {
  [CmdletBinding()]
  [alias('ConvertFromEpochTime', 'ConvertFromUnixTime')]
  param (
